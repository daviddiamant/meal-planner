...
export type EatingTogetherProps = {
  className: string;
  theme: Theme;
};

export const EatingTogether = ({
  className,
  theme: {
    colors: {
      primaryBlue: { value: blue },
      primaryOrange: { value: orange },
  ...
  >
    ...
    <ellipse cx="63.87" cy="514.57" opacity="0.1" rx="45" ry="16" />
    <ellipse cx="790.85" cy="580.72" opacity="0.1" rx="45" ry="16" />
    <path
    ...
    <path
      ...
      transform="translate(-148.11 -121.43)"
    />
    <rect fill="#40414d" height="194.86" width="13.59" x="265.44" y="402.64" />
    <rect fill="#40414d" height="194.86" width="13.59" x="562.26" y="402.64" />
    <path
    ...
    <rect
      ...
      y="532"
    />
    <rect fill="#40414d" height="108.18" width="11.89" x="152.17" y="503.59" />
    <rect fill="#40414d" height="108.18" width="11.89" x="246.08" y="503.59" />
    <path
    ...
    <path
      ...
      transform="translate(-148.11 -121.43)"
    />
    <rect fill="#f8bdc5" height="7.96" width="10.61" x="608.54" y="290.95" />
    <path
    ...
    <path
      ...
      transform="translate(-148.11 -121.43)"
    />
    <circle cx="608.98" cy="248.96" fill="#f8bdc5" r="32.71" />
    <path
    ...
    <path
      ...
      transform="translate(-148.11 -121.43)"
    />
    <circle cx="228.75" cy="261.25" fill="#f8bdc5" r="33" />
    <path
