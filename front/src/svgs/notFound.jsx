...
const NotFound = ({ className, theme }) => (
  <svg
    className={className}
  ...
  >
    ...
    <circle cx="212.59226" cy="103" r="64" fill={theme.primaryColors.orange} />
    <path
      ...
      fill={theme.quaternaryColors.grey}
    />
    <polygon
    ...
    <path
      ...
      transform="translate(-39.70387 -61.04208)"
      fill={theme.primaryColors.yellow}
    />
    <path
